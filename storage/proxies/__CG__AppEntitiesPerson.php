...
class Person extends \App\Entities\Person implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'email', 'messages', 'updatedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function addMessage(\App\Entities\Message $message)
    {
     ...
     * {@inheritDoc}
     */
    public function removeMessage(\App\Entities\Message $message)
    {
